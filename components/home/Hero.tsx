                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 xl:gap-20">
                    ...
                    >
                        ...
                        <motion.p variants={fadeIn} className="text-lg text-gray-600 mb-10 max-w-lg leading-relaxed">
                            Turn your gym into a professional, profitable business. Secure your entrance, automate your memberships, and watch your revenue grow with one simple platform.
                        </motion.p>
                        ...
                        <motion.div variants={fadeIn} className="mt-12 pt-8 border-t border-gray-100">
                            <p className="text-sm font-semibold text-gray-500 mb-5 uppercase tracking-wider">Trusted by the largest gyms in Ethiopia</p>
                            <div className="flex flex-wrap justify-center md:justify-between items-center w-full max-w-4xl gap-8 md:gap-0">
                                {[
                                    { src: "/logos/edf-logo.png", alt: "EDF", widthClass: "w-24 md:w-28", opacityClass: "opacity-70" },
                                    { src: "/logos/grand-palace-logo.png", alt: "Grand Palace", widthClass: "w-40 md:w-48", opacityClass: "opacity-100" },
                                    { src: "/logos/radiant-logo.webp", alt: "Radiant", widthClass: "w-24 md:w-28", opacityClass: "opacity-70", marginClass: "md:-ml-6" },
                                    { src: "/logos/roots-logo.png", alt: "Roots", widthClass: "w-24 md:w-28", imageClass: "invert", opacityClass: "opacity-70" },
                                ].map((logo) => (
                                    <div key={logo.alt} tabIndex={0} className={`relative h-12 grayscale hover:grayscale-0 hover:opacity-100 active:grayscale-0 active:opacity-100 focus:grayscale-0 focus:opacity-100 focus:outline-none transition-all duration-300 ${logo.widthClass} ${logo.opacityClass} ${logo.marginClass || ''}`}>
                                        <Image
                                            src={logo.src}
                                            alt={`${logo.alt} Logo`}
                                            fill
